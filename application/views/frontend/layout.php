    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 wow fadeInLeft" data-wow-delay="300ms">
                ...
                <h1 class="main-font font-weight-600 text-white">Trung tâm <span> âm nhạc</span> <span> Tại Pleiku</span></h1>
            </div>
            ...
            <div class="col-12 col-lg-6 m-ipad wow fadeInRight" data-wow-delay="300ms">
                <div class="ml-md-4 pl-md-2 font-weight-200 text-grey font-18">
                    <p>Trung tâm thành lập năm 2020 với sứ mệnh mang đến một nơi để cho mọi người được thỏa niềm đam mê với piano. </p>
                    <p>Với giảng viên chuyên nghiệp cùng với cơ sở vật chất tốt nhất, cam kết đem lại những kiến thức tốt nhất cho người học. </p>
                </div>
            </div>
        </div>
        <!-- About Boxes -->
        <div class="row about-margin">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="about-box center-block bg-green wow zoomIn" data-wow-delay="400ms">
                    ...
                    <h5>Có các khóa học<span> piano.</span></h5>
                </div>
            </div>
            <!-- Second Box -->
            <div class="col-md-4 col-sm-12">
                <div class="about-box center-block bg-blue wow zoomIn" data-wow-delay="500ms">
                    ...
                    <h5>Cung cấp, buôn bán<span>nhạc cụ piano.</span></h5>
                </div>
            </div>
            <!-- Third Box -->
            <div class="col-md-4 col-sm-12">
                <div class="about-box center-block bg-green wow zoomIn" data-wow-delay="600ms">
                    ...
                    <h5>Khách hàng là tất cả <span>với chúng tôi.</span></h5>
                </div>
            </div>
        </div>
        <!-- About Image
        <div class="d-flex justify-content-center wow bounceInLeft" data-wow-delay="300ms">
            <img src="<?php echo base_url() ?>public/corporate-agency/images/about-img.png" alt="About-Us">
        </div> -->
    </div>
</section>
<!-- END ABOUT US -->
                ...
                <div class="owl-carousel owl-theme owl-split">
                    ...
                    <div class="item">
                        <div class="hover-effect">
                            <img alt="blog" src="<?php echo base_url() ?>public/corporate-agency/images/team-img1.jpg" class="team-img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="skill-box">
                    <div class="main-title mb-5 text-center text-lg-left main-title wow fadeIn" data-wow-delay="300ms">
                        <p class="font-weight-200 text-pink font-20">Thành tựu của chúng tôi</p>
                        <h2 class="margin-top main-font font-40 font-weight-normal text-white">Chúng tôi đã đạt được </h2>
                    </div>
                    <ul class="text-left">
                        <!-- First Bar -->
                        <li class="custom-progress text-white">
                            <h6 class="font-16 mb-0 text-capitalize">Số lượng khóa học <span class="float-right"><b class="numscroller">155</b></span></h6>
                        ...
                        <!-- Second Bar -->
                        <li class="custom-progress text-white">
                            <h6 class="font-16 mb-0 text-capitalize">Số lượng học sinh<span class="float-right"><b class="numscroller">300</b></span></h6>

                            <div class="progress">
                                <div class="progress-bar bg-pink" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </li>
                        <!-- Third Bar -->
                        <li class="custom-progress text-white">
                            <h6 class="font-16 mb-0 text-capitalize">Số giờ giảng dạy <span class="float-right"><b class="numscroller">1200</b></span></h6>

                            <div class="progress">
                                <div class="progress-bar bg-pink" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </li>
                        <!-- Fourth Bar -->
                        <li class="custom-progress mb-0 text-white">
                            <h6 class="font-16 mb-0">Tỷ lệ học sinh đạt chuẩn<span class="float-right"><b class="numscroller">90</b>%</span></h6>
...
<!-- START PORTFOLIO -->
<section id="portfolio" class="padding portfolio" style="padding-bottom:0px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="title text-center pb-5 wow fadeInUp" data-wow-delay="100ms">
                    <h1 class="main-font font-weight-600 text-pink ">Khóa học</h1>
					<p class="font-weight-200 font-20 text-white">Của chúng tôi</p>
                ...
                <ul class="da-thumbs gallery">
                    ...
                    <li class="items Business Medical Agencies">
                        <img src="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img1.jpg" alt="img">
                        <a href="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img1.jpg" class="text-center" data-fancybox="images">
                            <div class="overlay">
                                <div>
                                    <div class="search-icon"><i class="fa fa-magic"></i></div>
                                    <h4 class="">Cơ bản</h4>
                                    <span>Học phí: 2.100.000 VNĐ/ 1 khóa</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <!-- Second Image -->
                    <li class="items Business Medical Agencies">
                        <img src="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img2.jpg" alt="img">
                        <a href="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img2.jpg" class="text-center" data-fancybox="images">
                            <div class="overlay">
                                <div>
                                    <div class="search-icon"><i class="fa fa-rocket"></i></div>
									<h4 class="">Nâng cao</h4>
                                    <span>Học phí: 3.200.000 VNĐ/ 1 khóa</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="items Personal Business">
                        <img src="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img3.jpg" alt="img">
                        <a href="<?php echo base_url() ?>public/corporate-agency/images/portfolio-img3.jpg" class="text-center" data-fancybox="images">
                            <div class="overlay">
                                <div>
                                    <div class="search-icon"><i class="fa fa-star"></i></div>
                                    <h4 class="">Đặc biệt</h4>
                                    <span>Học phí: Liên hệ !!!</span>
                                </div>
                            </div>
                        </a>
                    </li>
...
<!-- START PRICE -->
<section id="pricing" class="pricing" style="padding-top:20px">
    <div class="container">
        <div class="row">
            <!-- Plan-1 -->
            <div class="col-lg-4 col-md-12 col-sm-12 price-pink wow fadeInLeft" data-wow-delay="300ms">
                <div class="pricing-item">
                    <h3 class="pb-3 main-font font-24 text-white">Cơ bản</h3>
                    <div class="pricing-price d-flex"><span class="pricing-currency text-white">2.100.000</span><sup class="price-dollar text-white">VNĐ</sup>
                    </div>
                    <ul class="pricing-list mb-0">
                        <li><i class="fa fa-check" aria-hidden="true"></i> Cung cấp kiến thức cơ bản.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Nhạc lí cơ bản.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Đánh vài bài dễ.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Tempo music.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Tempo music.</li>
                    </ul>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 price-pink wow fadeInUp" data-wow-delay="500ms">
                <div class="pricing-item active selected">
					<h3 class="pb-3 main-font font-24 text-white">Nâng cao</h3></h3>
                    <div class="pricing-price d-flex"><span class="pricing-currency text-white">3.200.000</span><sup class="price-dollar text-white">VNĐ</sup>
                    </div>
                    <ul class="pricing-list mb-0">
                        <li><i class="fa fa-check" aria-hidden="true"></i> Cung cấp kiến thức nâng cao.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Nhạc lí nâng cao.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Đánh cac bài khó.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Ôn thi đại học.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Tempo music.</li>
                    </ul>
                    <!-- <a href="javascript:void(0)" class="btn btn-medium rounded-pill w-100 portfolio-btn-pink">Choose Plan</a> -->
                </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 price-pink wow fadeInRight" data-wow-delay="300ms">
                <div class="pricing-item">
				<h3 class="pb-3 main-font font-24 text-white">Đặc biệt</h3></h3>
                    <div class="pricing-price d-flex"><span class="pricing-currency text-white">Liên hệ !!!</span>
                    </div>
                    <ul class="pricing-list mb-0">
					<li><i class="fa fa-check" aria-hidden="true"></i> Cung cấp kiến thức nâng cao.</li>
                        <li><i class="fa fa-check" aria-hidden="true"></i> Tempo music.</li>
                ...
                <div id="testimonial-carousal" class="owl-carousel owl-theme testimonial-owl text-center wow fadeIn" data-wow-delay="300ms">
                    ...
                    <div class="item">
                        ...
                        <div class="description">
                            <p class="text-white paragraph">Cháu nhà mình sau khi học khóa cơ bản đã biết chơi piano, thầy giáo dạy nhiệt tình. </p>
                        </div>
                        <div class="testimonial-img mt-4">
                            <img src="<?php echo base_url() ?>public/corporate-agency/images/testimonial-1.jpg" alt="student img">
                        </div>
                        <div class="testimonial-tittle mt-3 mb-3">
                            <h3 class="mb-0 text-white alt-font font-weight-normal font-24">Chị Hoa "phụ huynh cháu Linh"</h3>
                        </div>
                    </div>
        ...
        <div class="row align-items-center blog-bg">
            <div class="col-lg-6 col-md-12 p-0 order-1 order-md-2">
                <div class="owl-carousel owl-theme owl-split">
                    ...
                    <div class="item">
                        <div class="hover-effect">
                            <img alt="blog" src="<?php echo base_url() ?>public/corporate-agency/images/blog-img1.jpg" class="team-img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="align-items-center pc-0 px-md-5 skill-box">
                    <div class="main-title mb-5 text-center text-lg-left wow fadeIn" data-wow-delay="300ms">
                        <p class="text-pink font-weight-200 font-20">Tin tức</p>
                        <h1 class="main-font font-weight-600 text-white margin-top">Tempo music</h1>
                        <p class="font-15 alt-font font-weight-normal text-grey margin-top">Cập nhật những tin tức mới nhất của trung tâm chúng toi.</p>
                        <a href="<?php echo base_url() ?>public/corporate-agency/blog.html" class="mt-3 btn btn-medium btn-rounded btn-pink">Đọc</a>
                    </div>
                </div>
            </div>
        </div>
