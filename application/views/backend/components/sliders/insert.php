...
<div class="content-wrapper" style="min-height: 454px;">
	<form action="<?php echo base_url() ?>admin/sliders/insert.html" enctype="multipart/form-data" method="post" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-picture"></i> Thêm ảnh</h1>
						...
						<div class="box-body">
							<div class="col-md-9">
								...
								<div class="form-group">
									...
									<input type="text" name="name" placeholder="Tên ảnh" class="form-control">
									<div class="error" id="password_error"><?php echo form_error('name') ?></div>
								</div>
								<div class="form-group">
									<label>Ảnh<span class="maudo">(*)</span></label>
